                ...
                <nav className="mt-4 relative max-w-2xl w-full bg-white border border-gray-200 rounded-[2rem] mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
                    ...
                    >
                        <div className="flex flex-col md:flex-row md:items-center md:justify-end gap-2 md:gap-3 mt-3 md:mt-0 py-2 md:py-0 md:ps-7">
                            ...
                            <Link
                                className={" py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 font-medium text-gray-800 hover:text-white focus:outline-none "+( path === '/login' ? 'border-neutral-200 text-neutral-200' : 'border-transparent text-neutral-400' )}
                                href="/login"
                                aria-current="page"
                            >
                                Login
                            ...
                            <Link
                                className={" py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 font-medium text-gray-800 hover:text-white focus:outline-none "+( path === '/signup' ? 'border-neutral-200 text-neutral-200' : 'border-transparent text-neutral-400' )}
                                href="/signup"
                                aria-current="page"
                            >
                                Sign Up
                            ...
                            <Link
                                className={" py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 font-medium text-gray-800 hover:text-white focus:outline-none "+( path === '/contact' ? 'border-neutral-200 text-neutral-200' : 'border-transparent text-neutral-400' )}
                                href="/contact"
                                aria-current="page"
                            >
                                Contact
